    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('personal', 'شخصي'), ('business', 'أعمال')], default='personal', max_length=20, verbose_name='نوع الحساب')),
                ...
                ('profile_picture', models.ImageField(default='profile_pics/default.jpg', upload_to='profile_pics', verbose_name='الصورة الشخصية')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_type', models.CharField(choices=[('home', 'منزل'), ('work', 'عمل'), ('other', 'آخر')], default='home', max_length=20, verbose_name='نوع العنوان')),
                ('street_address', models.TextField(verbose_name='العنوان التفصيلي')),
